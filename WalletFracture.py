...
cells = []
balances = [0]*(4**outputs_exponent) #List of balances in wallet
...
stop_balance = start_balance/2**outputs_exponent #Split balance until under all outputs this value
